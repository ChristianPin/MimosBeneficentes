<%-- 
    Document   : admInst
    Created on : 19/05/2019, 20:48:26
    Author     : cyms8
--%>
    ...
    <body>
        ...
        <div class="servicos" id="serv">
            <div class="texto-servicos">
                <h1>Instituição</h1>
                <a href="addInst" class="btn btn-adm btn-azul">Cadastrar instituição</a>
                <a href="listaInst" class="btn btn-adm btn-rosa">Lista das Instituições</a>
            </div>
        </div>
    </body>
</html>
